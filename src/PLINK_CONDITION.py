...
class CONDITION(object):
    ...
    def __init__(self, _condition:str=None, _condition_list:str=None, _l_markers:list=()):
        ...
        self.condition_list = checkFile2(_condition_list, std_ERROR + "Given PLINK Condition file('{}') can't be found.".format(_condition))
        self.f_null_cond = (self.condition == None) and (self.condition_list == None)
    ...
    def __bool__(self): return (isinstance(self.condition, str) and (len(self.condition) > 0)) != Exists(self.condition_list) # xor
...
if __name__ == '__main__':
    ...
    # test 2 - file
    _condition_list = "/Users/wansonchoi/Git_Projects/HATK/tests/20221007_bMG/asdf.condvars"

    cond = CONDITION(_condition_list=_condition_list)
    print(cond)
    print(bool(cond))
