...
### (2018. 7. 30.) Previous "MakeReference.py" main function signature
# def MakeReference(_INPUT_DATA, _HLA_ped, _OUT,
...
def MakeReference(_INPUT_DATA, _HLA_ped, _OUT,
    ...
    """
    (2018. 8. 1.) Argument "_only_markers" introduced.
    ...
    p_src_MakeReferece = os.path.join(_p_src, "MakeReference{0}".format("" if not _previous_version else "_old"))
    # print("\n[2018. 7. 30] : 'p_src_MakeReferece' is {0}\n".format(p_src_MakeReferece))
    # sys.exit()
    ...
    # print("\n[2018. 7. 30] : _p_plink, _p_beagle, _p_link..\n{0}\n{1}\n{2}\n\n".format(_p_plink, _p_beagle, _p_linkage2beagle))
    # sys.exit()
    ...
    SNP_DATA2 = os.path.join(INTERMEDIATE_PATH, os.path.basename(_INPUT_DATA)) # for each output directory
    ...
    if _only_markers:
        ...
        # When "_only_markers" flags is True, then this process ends here so that output generated so far will be only "Marker Panel".
        print(std_MAIN_PROCESS_NAME + "Marker Panel is successfully generated.\n")
        return 0
...
if __name__ == "__main__" :
    ...
    MakeReference(_INPUT_DATA=args.i, _HLA_ped=args.ped, _OUT=args.o, _dictionary_AA_map=t_dict_AA_map,
                  ...
                  _previous_version=args.previous_version, _hg=args.hg)